  ...
  return ( 
    <div className='mt-12'>
      <div className=' flex flex-wrap lg:flex-wrap justify-center'>
        ...
        h-44 rounded-xl w-full lg:w-80 p-8 pt-9 m-3 bg-hero-pattern bg-no-repeat bg-cover bg-center' >
          ...
          <div className='flex justify-between items-center'>
            <div>
              <p className='font-bold text-gray-400'>Parámetros del Rover</p>
              <p className='text-2xl'>$456532.13 </p>
            </div>
      ...
      <div className='flex gap-10 flex-wrap justify-center'>
        <div className='bg-white dark:text-gray-200 dark:bg-seconday-dark-bg m-3
        p-4 rounded-2xl md:w-780'>
          <div className='flex justify-between'>
            <p className='font-semibold text-xl'> Estado de la batería</p>
          ...
          <div className='mt-10 flex gap-10 flex-wrap justify-center'>
            <div className='border-r-1 border-color m-4 pr-10'>
              <div>
                <p>
                  <span className='text-3xl font-semibold'>130BPM</span>
                  <span className='p-1.25 hover:drop-shadow-xl
                  cursor-pointer rounded-full text-white bg-green-400 ml-3 text-xs'>110%
                  </span>
                </p>
              ...
              <div className='mt-8'>
                <p>
                  <span className='text-3xl font-semibold'>80BPM</span>                </p>
                <p className='text-gray-500 mt-1'>
                  Expense</p>
              </div>
              <div className='m4-5'>
